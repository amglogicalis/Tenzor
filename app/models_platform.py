...
class CreateAgentRequest(BaseModel):
    ...
    preferred_provider: Optional[str] = Field(None, pattern=r"^(google|groq|openrouter|deepseek|xai|perplexity|mistral|together|fireworks|cerebras|sambanova|siliconflow)$")
